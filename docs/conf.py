...
project = "django-elevate"
copyright = "%s, Justin Mayer" % datetime.date.today().year
...
version = version("django_elevate")
...
man_pages = [
    ("index", "django-elevate", "django-elevate Documentation", ["Justin Mayer"], 1)
]
